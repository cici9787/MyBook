...
parser.add_argument("--model", type=str, help="the model to fine-tune", default="gpt2")
...
# /home/jovyan/lecture-notes/14-fine-tuning-02/fine-tuning-lab.zip is not UTF-8 encoded
